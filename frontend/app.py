...
Product_Allocated_Area = st.number_input("Product Allocated Area", min_value=0.0, value=0.05) #Complete the code to define the UI element for Product_Allocated_Area
